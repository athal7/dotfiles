Changeset touches UI (views, templates, CSS, frontend) → dispatch `qa` for browser verification of the affected flows (construct the task() dispatch from `qa-verification`).
