...
const isMergeableObject_1 = require("./isMergeableObject");
function emptyTarget(val) {
    return Array.isArray(val) ? [] : {};
}
function cloneUnlessOtherwiseSpecified(value) {
    return isMergeableObject_1.default(value) ? deepmerge(emptyTarget(value), value) : value;
}
