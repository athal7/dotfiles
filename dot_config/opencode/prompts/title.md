...
- STRIP any leading slash-command and its workflow verb. Commands like /implement, /mr, /review, /cleanup, /fix-prod-errors, /learn, /kb-enrich are workflow wrappers — NEVER name a session after the command itself or its action ("implementing", "reviewing", "fixing", "cleaning up").
...
"/review https://.../merge_requests/482" → Review MR 482
