...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin12.4.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/andrewthal/.rbenv/versions/1.9.3-p448")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/andrewthal/.rbenv/versions/1.9.3-p448' 'CC=gcc-4.2' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L'\\\\''/Users/andrewthal/.rbenv/versions/1.9.3-p448/lib'\\\\'' ' 'CPPFLAGS=-I'\\\\''/Users/andrewthal/.rbenv/versions/1.9.3-p448/include'\\\\'' '"
  ...
  CONFIG["cppflags"] = "-I'/Users/andrewthal/.rbenv/versions/1.9.3-p448/include' "
  CONFIG["NULLCMD"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I'/Users/andrewthal/.rbenv/versions/1.9.3-p448/include'  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L'/Users/andrewthal/.rbenv/versions/1.9.3-p448/lib' "
