...
- AI tools: the complete [OMP config](dot_omp/private_agent/private_config.yml) is directly managed; [MCP servers](.chezmoidata/mcp.yaml), [agent skills](dot_agents/skills/), and [Agent of Empires](dot_agent-of-empires/modify_config.toml) session tools and keyboard shortcuts.
