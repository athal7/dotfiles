...
- **Automation**
  ...
  - [LaunchAgents](Library/LaunchAgents/) — scheduled macOS tasks, including a daily 7am production-error triage (`fix-prod-errors`) that dispatches worktree fix sessions
